require("./basemods/global")

const func = require("./basemods/place")
...
Biiofc.sendMessage(anu.id, { image: fs.readFileSync(`./basemods/tmp/welcome1.png`), mentions: [num], caption: `✧━━━━━━[ *WELCOME* ]━━━━━━✧
...
Biiofc.sendMessage(anu.id, { image: fs.readFileSync(`./basemods/tmp/goodbye1.png`), mentions: [num], caption: `✧━━━━━━[ *GOOD BYE* ]━━━━━━✧
Sayonara *@${num.split('@')[0]}* 👋

*LAIN KALI JANGAN MASUK YAHH ANJING*'` })
}
}
} catch (err) {
console.log(err)
